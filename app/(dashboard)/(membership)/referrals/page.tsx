      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-start pt-6">
        ...
        >
          ...
          <motion.header variants={itemVariants} className="space-y-6 text-center lg:text-left flex-1 max-w-xl">
            <h1 className="bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text py-1.5 text-3xl font-extrabold leading-tight text-transparent sm:text-5xl md:text-6xl drop-shadow-[0_0_20px_rgba(168,85,247,0.18)] animate-gradient">
