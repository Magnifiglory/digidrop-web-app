...
const DailySpinCard = ({ targetDate }: Prop) => {
  ...
  return (
    <div className="group flex w-full flex-col sm:flex-row items-center sm:items-center justify-between gap-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl px-5 py-4 hover:shadow-[0_0_25px_rgba(168,85,247,0.15)] hover:border-purple-500/20 transition-all duration-500">
      <div className="w-full flex items-center gap-3">
        <img src="/assets/iconLogo.webp" alt="logo" className="h-8 w-8 transition-transform duration-1000 ease-out group-hover:rotate-[360deg]" />
